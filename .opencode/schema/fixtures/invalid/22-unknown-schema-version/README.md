...
Defect: the `22-unknown-schema-version` case. The validator must emit exactly 1 diagnostic(s):
SCHEMA_VERSION
...
Expected diagnostic: `halucinator/handoff/01-sources.toml|handoff.schema|SCHEMA_VERSION`
