...
Defect: the `11-noncanonical-digest` case. The validator must emit exactly 1 diagnostic(s):
NONCANONICAL_DIGEST
...
Expected diagnostic: `halucinator/handoff/02-facts.toml|handoff.inputs|NONCANONICAL_DIGEST`
