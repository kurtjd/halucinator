...
Defect: the `18-stale-non-review-evidence` case. The validator must emit exactly 1 diagnostic(s):
STALE_EVIDENCE
...
Expected diagnostic: `halucinator/handoff/02-facts.toml|handoff.notes|STALE_EVIDENCE`
