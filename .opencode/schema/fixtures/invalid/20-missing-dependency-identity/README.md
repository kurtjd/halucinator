...
Defect: the `20-missing-dependency-identity` case. The validator must emit exactly 1 diagnostic(s):
DEPENDENCY_IDENTITY
...
Expected diagnostic: `halucinator/handoff/05-platform.toml|platform.dependencies|DEPENDENCY_IDENTITY`
