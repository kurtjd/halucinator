...
Defect: the `02-missing-required` case. The validator must emit exactly 1 diagnostic(s):
MISSING_FIELD
...
Expected diagnostic: `halucinator/handoff/01-sources.toml|sources.route|MISSING_FIELD`
